 ...
 */
class You_Can_Quote_Me_On_That_Form_Control {
	...
	public function render_content() {
		...
		switch( $this->type ) {
			...
			case 'media_upload':
				...
				$html .= '<p class="hide-if-no-js"><a title="' . esc_attr__( 'Upload Image', 'you-can-quote-me-on-that' ) . '" href="javascript:;" class="button upload" data-uploader_title="' . esc_attr__( 'Upload Image', 'you-can-quote-me-on-that' ) . '" data-uploader_button_text="' . esc_attr__( 'Upload Image', 'you-can-quote-me-on-that' ) . '">' . esc_html__( 'Upload Image', 'you-can-quote-me-on-that' ) . '</a></p>';				
				...
				$html .= '<i class="ycqmot-fa ycqmot-fa-times"></i>';		
				$html .= '</div>';
				...
				if ( $has_image ) {
					...
					$html .= '<img src="" />';
					//$html .= '<p class="hide-if-no-js"><a title="' . esc_attr__( 'Upload Image', 'you-can-quote-me-on-that' ) . '" href="javascript:;" id="upload_header_image_button" class="button upload" data-uploader_title="' . esc_attr__( 'Upload Image', 'you-can-quote-me-on-that' ) . '" data-uploader_button_text="' . esc_attr__( 'Upload Image', 'you-can-quote-me-on-that' ) . '">' . esc_html__( 'Upload Image', 'you-can-quote-me-on-that' ) . '</a></p>';
			...
			case 'repeatable_fieldset':
				ob_start();
				include ( you_can_quote_me_on_that()->assets_dir .'/template-parts/'. $this->template );
				$html .= ob_get_clean();
			break;
		}
